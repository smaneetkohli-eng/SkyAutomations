...
import { PlayCircle, Zap, Syringe, Gift, Users } from 'lucide-react'

const stats = [
  { value: '98%', label: 'of text messages are read within 3 minutes' },
  { value: '30%', label: 'of SMS marketing campaigns result in immediate sales' },
  { value: '62%', label: 'of consumers say they are likely to engage with SMS promotions' },
]
...
const featureCards = [
  {
    ...
    desc: "Give us a list of at least 150 of your past customers and leads you haven't been able to close. We'll run a campaign to get them through the door again.",
  },
  {
    icon: Syringe,
    title: 'Contractor 5-Star Review Injector',
    desc: "Provide us with a list of at least 150 past customers. We'll launch a review campaign offering a small incentive to encourage them to leave feedback and come back.",
  },
  {
    icon: Gift,
    title: 'Contractor Holiday Promos',
    desc: "Share a list of at least 150 past customers or leads, and we'll run a holiday promo campaign to bring them back. We'll offer special discounts or incentives to rekindle their interest and boost your seasonal sales.",
  },
  {
    icon: Users,
    title: 'Contractor Customer Nurture',
    desc: "Give us a list of at least 150 past clients or leads and we'll run a customer nurture campaign to re-engage them. We'll send personalized follow-ups and offers to keep your services top-of-mind and encourage repeat business.",
  },
]
    ...
    <>
      ...
      <section className="pt-28 pb-10 bg-white text-center px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Re-engage past customers instantly — your best new jobs are hiding in your old contact list.
          </p>
        </div>
      </section>
      ...
      <section className="pt-10 pb-20 px-4" style={{ background: '#0F172A' }}>
        <div className="max-w-xl mx-auto">
          ...
          >
            ...
            >
              Turn your past customers into new revenue
            </h2>
            <p

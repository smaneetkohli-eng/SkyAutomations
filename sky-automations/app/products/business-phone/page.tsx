...
import { PlayCircle, Smartphone, Share2, MessageSquare, DollarSign } from 'lucide-react'

const stats = [
  { value: '89%', label: 'of customers prefer texting a business over calling' },
  { value: '1 in 3', label: 'small contractors use their personal cell for business, making it impossible to separate or track professionally' },
  { value: '$0', label: 'extra cost to you. Your dedicated business number is fully included in your monthly plan.' },
]

const featureCards = [
  {
    icon: Smartphone,
    title: 'Stop Handing Out Your Personal Number',
    desc: "Once your cell number is out there, you can't take it back. A dedicated line keeps work where it belongs — professional and separate.",
  },
  {
    icon: Share2,
    title: 'Plugged Into Every Automation',
    desc: 'The missed call text-back, review requests, and follow-up messages all fire from this number. One consistent, professional line across every touchpoint.',
  },
  {
    icon: MessageSquare,
    title: 'Text and Call From One Number',
    desc: 'Customers text you, you text back — all from a real business number. Not a random personal cell that looks like spam.',
  },
  {
    icon: DollarSign,
    title: 'We Cover the Cost',
    desc: 'A business phone line normally runs $25–$40/mo on its own. We absorb that into your plan so you get a professional number without paying anything extra.',
  },
]
    ...
    <>
      ...
      <section className="pt-28 pb-10 bg-white text-center px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            One number for every customer, every text, every call — fully covered in your plan.
          </p>
        </div>
      </section>
      ...
      <section className="pb-10 px-4" style={{ background: '#0F172A' }}>
        <div className="max-w-6xl mx-auto">
          ...
          >
            Why do I need a Dedicated Business Phone?
          </h2>
      ...
      <section className="pt-10 pb-20 px-4" style={{ background: '#0F172A' }}>
        <div className="max-w-xl mx-auto">
          ...
          >
            ...
            >
              One number. Every customer. Nothing extra.
            </h2>
            <p
              className="text-lg mb-8"
              style={{ color: '#6B7280', fontFamily: 'var(--font-dm-sans)', fontWeight: 300 }}
            >
              Book a free call and we&apos;ll walk you through how your dedicated business line fits into everything we build for you.
            </p>
